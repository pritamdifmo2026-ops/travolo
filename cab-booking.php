...
<head>
    ...
    <style>
        ...
        .cab-feature-section {
            padding: 30px 0 80px;
            /* Reduced top padding from 80px to 30px */
            background: #fff;
        }
        ...
        .offer-card {
            ...
            /* Reduced from 380px to eliminate whitespace */
            overflow: hidden;
        ...
        .banner-info {
            ...
            height: 100%;
            padding: 22px 25px;
            /* Increased padding-left to 25px */
            display: flex;
            flex-direction: column;
            justify-content: center;
            color: #fff;
        ...
        .bg-travolo-main {
            background: linear-gradient(135deg, #00a79d 0%, #00796af0 100%);
        }

        .bg-travolo-dark {
            background: linear-gradient(135deg, #133a25 0%, #0c2518 100%);
        }
        ...
        .service-name {
            font-size: 14px;
            /* Reduced from 16px for a more refined look */
            font-weight: 900;
            margin-bottom: 10px;
            line-height: 1.2;
        }
        ...
        .hourly-slider-section {
            padding: 40px 0 30px;
            /* Reduced bottom padding from 120px to 30px */
            background: #fff;
            position: relative;
        }
        ...
        .hourly-card {
            ...
            /* Extra bottom margin for floating box */
            height: 320px;
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05);
            transition: all 0.4s ease;
        }
        ...
        .hourly-info-box {
            position: absolute;
            bottom: -45px;
            /* Lowered from -30px to show more image */
            left: 15px;
            right: 15px;
            background: #fff;
            border-radius: 20px;
            padding: 12px 18px;
            /* Reduced from 18px 20px for a more compact look */
        ...
        .slick-prev-hourly:hover,
        .slick-next-hourly:hover {
            background: #00a79d;
            color: #fff;
        ...
        .offer-arrow.prev-offer {
            left: -25px;
        }

        .offer-arrow.next-offer {
            right: -25px;
        }
        ...
        .overseas-body-content {
            padding: 25px;
        }

        .overseas-body-content h4 {
            font-size: 22px;
            font-weight: 800;
            margin-bottom: 10px;
            color: #133a25;
...
<body>
    ...
    <section class="services-seciton">
        <div class="container">
                            ...
                            <div class="form-group-custom">
                                ...
                                <div class="cab-wrapper" id="fromCabWrapper">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="from" class="form-control cab-input"
                                            placeholder="Type city or airport" required>
                            ...
                            <div class="form-group-custom">
                                ...
                                <div class="cab-wrapper" id="toCabWrapper">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="to" class="form-control cab-input"
                                ...
                                <div class="input-with-icon cursor-pointer" id="pickupTrigger">
                                    ...
                                    <div class="time-dropdown-menu" id="pickupDropdown">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="pickupDateInput"
                                                min="<?php echo date('Y-m-d'); ?>">
                                        </div>
                                        <div class="time-picker-item">
                                            <label class="small text-muted mb-1">Pick Time</label>
                                            <div class="input-group-custom">
                                                <input type="number" class="hour-input" id="hourInput" placeholder="HH"
                                                    min="1" max="12" value="12">
                                                <input type="number" class="minute-input" id="minuteInput"
                                                    placeholder="MM" min="0" max="59" value="00">
                                        ...
                                        <button type="button" class="main-btn primary-btn w-100 mt-3 py-2">Set
                                            Time</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="input-with-icon cursor-pointer" id="returnTrigger">
                                    ...
                                    <div class="time-dropdown-menu" id="returnDropdown">
                                        ...
                                        <div class="time-picker-item">
                                            ...
                                            <div class="input-group-custom">
                                                <input type="number" class="hour-input" id="returnHourInput"
                                                    placeholder="HH" min="1" max="12" value="12">
                                                <input type="number" class="minute-input" id="returnMinuteInput"
                                                    placeholder="MM" min="0" max="59" value="00">
            ...
            <div id="cabResultsContainer" class="container" style="margin-top:-30px; position:relative; z-index:5;">
            </div>
            ...
            <div class="cab-offers-section">
                <div class="container" style="position: relative;">
                    <div class="d-flex align-items-center justify-content-center mb-60">
                        <h2 class="mb-0" style="font-weight: 900; font-size: 44px; color: #133a25;">Travolo Exclusive
                            Offers</h2>
                    </div>
                                ...
                                <a href="#" class="offer-card">
                                    ...
                                    <div class="offer-split-banner">
                                        <div class="banner-info"
                                            ...
                                            <div class="discount-text"><?php echo htmlspecialchars($offer['header_small']); ?>
                                            </div>
                                    ...
                                    <div class="offer-body">
                                        ...
                                        <div class="validity-text"><?php echo htmlspecialchars($offer['validity_text']); ?>
                                        </div>
                                    </div>
                                </a>
                                <?php
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="overseas-card">
                                ...
                                <div class="overseas-body-content text-start">
                                    ...
                                    <a href="#cabSearchForm" class="overseas-action-btn">Book Overseas Ride <i
            ...
            <div class="hourly-slider-section mt-60">
                <div class="container">
                    <div class="row align-items-end mb-40">
                        <div class="col-lg-8">
                            <div class="section-title">
                                <span class="sub-title" style="color: #00a79d; font-weight: 800;">LOCAL
                                    EXPLORATION</span>
                        ...
                        if ($hourly_res && $hourly_res->num_rows > 0) {
                            while ($h = $hourly_res->fetch_assoc()) {
                                ...
                                <div class="hourly-card">
                                    <img src="<?php echo htmlspecialchars($h['image_path']); ?>"
                                        alt="<?php echo htmlspecialchars($h['city']); ?>">
                                    <div class="hourly-info-box">
                                        <div class="hourly-info-top">
                                            <div>
                                                <div class="hourly-city-name"><?php echo htmlspecialchars($h['city']); ?></div>
                                                <div class="hourly-loc-tag"><?php echo htmlspecialchars($h['location_tag']); ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="hourly-info-bottom">
                                            <div class="hourly-price-row">
                                                ...
                                                <span
                                                    class="hourly-price-val">₹<?php echo number_format($h['price_per_hr']); ?></span>
                                            </div>
                                            <a href="cab-results.php?tripType=Hourly&from=<?php echo urlencode($h['city']); ?>&to=Local"
                                                class="hourly-btn">Book <i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <?php
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-5">
                            <div class="outstation-text-box">
                                ...
                                <h2 class="outstation-title">The Elite <br>Intercity <span
                                        style="color: #00a79d;">Corridor</span></h2>
                                <p class="outstation-sub-title">Bypass the ordinary. Our premium outstation service
                                    offers door-to-door luxury across India's most popular routes.</p>

                                <a href="#cabSearchForm" class="outstation-book-btn">Secure Your Ride <i
                                        class="fas fa-shield-alt ms-2"></i></a>
                            </div>
                        </div>
                        <div class="col-xl-7">
            ...
            <div class="row mb-60 justify-content-center text-center">
                <div class="col-lg-8">
                    <span class="sub-title"
                        style="color: #00a79d; display: block; margin-bottom: 20px; font-weight: 800;">TRAVEL
                        INSIGHTS</span>
                    <h2 style="color: #fff; font-size: 42px; font-weight: 800;">Everything You Need for a Seamless
                        Journey</h2>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>Travolo simplifies your travel with premium airport transfers and outstation journeys.
                            Whether you're heading for a business meeting or a weekend getaway, our user-friendly
                            platform ensures a hassle-free booking experience with guaranteed punctuality.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>Your safety is our top priority. We partner only with verified chauffeurs and offer SOS
                            features within our booking flow. Our rigorous vehicle inspection and driver-health checks
                            ensure you enjoy peace of mind on every single ride.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>Explore hidden gems and popular destinations with our outstation services. We provide both
                            one-way and round-trip options with top-rated drivers who are experts in highway navigation,
                            ensuring you reach your destination refreshed.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>Get the best value for your money with Travolo's transparent pricing. We offer seasonal
                            discounts, loyalty rewards, and early bird specials on airport rentals. No hidden
                            surcharges, no surprise fees—just premium service at honest prices.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>From sleek sedans for business to spacious SUVs for family trips, our fleet is diverse and
                            well-maintained. All our vehicles are equipped with GPS tracking, air conditioning, and
                            premium interior to match your style and needs.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="insight-card">
                        ...
                        <p>With 24/7 customer support, a wide network of local partners, and a focus on premium traveler
                            comfort, Travolo stands as the top choice for smart travelers. We don't just provide a ride;
                            we provide an elite travel experience.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <style>
        .modal-all-offers .modal-content {
            border-radius: 30px;
            border: none;
            overflow: hidden;
        }

        .modal-all-offers .modal-header {
            background: #133a25;
            color: #fff;
            padding: 25px;
            border: none;
        ...
        .modal-all-offers .btn-close {
            filter: invert(1);
            opacity: 1;
        }

        .modal-all-offers .offer-grid-item {
            margin-bottom: 30px;
            height: 100%;
        }

        .modal-all-offers .offer-card {
            transform: scale(1) !important;
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);
            height: 100%;
        }

        .modal-all-offers .offer-card:hover {
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" style="font-size: 24px;">TravoLo Exclusive Offers - All Active Deals
                    </h5>
