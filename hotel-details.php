            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div class="search-info">
                    ...
                    <span class="search-text">
                        ...
                        if (!$ci_time || date('Y', $ci_time) > 2030 || date('Y', $ci_time) < 2024)
                            $ci_time = time();
                        ...
                        if (!$co_time || $co_time <= $ci_time || date('Y', $co_time) > 2030)
                            $co_time = strtotime('+1 day', $ci_time);
            ...
            <div class="modal-content border-0 rounded-4 shadow overflow-hidden">
                ...
                <div class="modal-body p-3">
                    <div class="mb-3 p-2 bg-light rounded-3 border-start border-warning border-4">
                        ...
                        <div class="small text-muted" style="font-size: 11px;">Base Price: ₹<span
                                id="sumBasePrice"></span></div>
                    </div>
                    <form id="bookingQueryForm">
                        ...
                        <div class="mb-2"><label class="small fw-bold mb-1">Full Name</label><input type="text"
                                name="name" class="form-control form-control-sm rounded-3"
                        ...
                        <div class="row g-2">
                            <div class="col-6 mb-2"><label class="small fw-bold mb-1">Email</label><input type="email"
                                    name="email" class="form-control form-control-sm rounded-3"
                                    value="<?php echo htmlspecialchars($_SESSION['user_email'] ?? $_GET['email'] ?? ''); ?>"
                                    placeholder="example@mail.com" required></div>
                            <div class="col-6 mb-2"><label class="small fw-bold mb-1">Mobile</label><input type="tel"
                                    name="phone" class="form-control form-control-sm rounded-3" value="<?php
                                    $mob = $_SESSION['user_phone'] ?? $_GET['mobile'] ?? '';
                                    echo htmlspecialchars($mob);
                                    ?>" placeholder="10 Digit Mobile" required pattern="[6-9][0-9]{9}" maxlength="10"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                    title="Please enter a valid 10-digit mobile number starting with 6-9"></div>
                        </div>
                        <div class="row g-2">
                            <div class="col-6 mb-2"><label class="small fw-bold mb-1">Check-in</label><input type="date"
                                    ...
                                    min="<?php echo date('Y-m-d'); ?>" value="<?php
                                       ...
                                       ?>" required></div>
                            <div class="col-6 mb-2"><label class="small fw-bold mb-1">Check-out</label><input
                                    type="date" name="check_out" id="modalCheckOut"
                                    class="form-control form-control-sm rounded-3" min="<?php echo date('Y-m-d'); ?>"
                                    value="<?php
                        ...
                        <div class="mb-2 position-relative">
                            ...
                            <div class="dropdown">
                                <button
                                    class="form-control form-control-sm rounded-3 text-start d-flex justify-content-between align-items-center"
                                    type="button" id="guestPickerBtn" data-bs-toggle="dropdown"
                                ...
                                <div class="dropdown-menu p-3 shadow-lg border-0 rounded-3" style="width: 250px;">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <button type="button"
                                                ...
                                                onclick="changeCount('rooms', -1)">-</button>
                                            <span id="count_rooms" class="fw-bold px-1"
                                                style="min-width:15px;text-align:center;">1</span>
                                            <button type="button"
                                                class="btn btn-sm btn-outline-secondary rounded-circle p-0"
                                                style="width:24px;height:24px;"
                                                onclick="changeCount('rooms', 1)">+</button>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span id="count_adults" class="fw-bold px-1"
                                                style="min-width:15px;text-align:center;">2</span>
                                            <button type="button"
                                                class="btn btn-sm btn-outline-secondary rounded-circle p-0"
                                                style="width:24px;height:24px;"
                                                onclick="changeCount('adults', 1)">+</button>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span id="count_children" class="fw-bold px-1"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <button type="button"
                                                class="btn btn-sm btn-outline-secondary rounded-circle p-0"
                                                style="width:24px;height:24px;"
                                                onclick="changeCount('infants', -1)">-</button>
                                            <span id="count_infants" class="fw-bold px-1"
                                                style="min-width:15px;text-align:center;">0</span>
                                            <button type="button"
                                                class="btn btn-sm btn-outline-secondary rounded-circle p-0"
                                                style="width:24px;height:24px;"
