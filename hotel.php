            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section-title text-center mb-50 wow fadeInDown">
                        ...
                        <h2>Hotel Booking FAQs</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="accordion" id="hotelFaqAccordion">
                        <?php
                        if (isset($conn)):
                            $faqs = $conn->query("SELECT * FROM faqs WHERE status = 1 AND category = 'Hotel' ORDER BY sort_order ASC LIMIT 5");
                            if ($faqs && $faqs->num_rows > 0):
                                while ($faq = $faqs->fetch_assoc()):
                                    ?>
                                    <div class="accordion-item border-0 mb-3 shadow-sm rounded-4 overflow-hidden">
                                        <h2 class="accordion-header" id="hHeading<?php echo $faq['id']; ?>">
                                            <button class="accordion-button collapsed fw-bold py-4 px-4 bg-white" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#hCollapse<?php echo $faq['id']; ?>"
                                                aria-expanded="false" aria-controls="hCollapse<?php echo $faq['id']; ?>"
                                                style="font-size: 18px; color: #133a25;">
                                                <?php echo htmlspecialchars($faq['question']); ?>
                                            </button>
                                        </h2>
                                        <div id="hCollapse<?php echo $faq['id']; ?>" class="accordion-collapse collapse"
                                            aria-labelledby="hHeading<?php echo $faq['id']; ?>" data-bs-parent="#hotelFaqAccordion">
                                ...
                                <div class="text-center p-5 bg-light rounded-4">
                                    ...
                                    <p class="text-muted mb-0">Have questions about hotels? Check our <a href="contact.php"
