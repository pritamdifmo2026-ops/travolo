...
if (!$serviceable) {
    ...
    echo "<div class='text-center py-5 bg-white border-dashed rounded-3 shadow-sm'>
            ...
            <p class='text-muted px-5'>Sorry, but we currently do not provide $displayTripType services for <b>".htmlspecialchars($from)."</b>. Please try another city or contact us for personalized support.</p>
          </div>";
    exit;
}
...
if ($city_pack) {
    ...
    <style>
        ...
        .car-image-box { width: 200px; min-width: 200px; height: 120px; display: flex; align-items: center; justify-content: center; background: #f8f9fa; border-radius: 12px; }
    ...
    <div class="city-pack-banner d-none d-md-flex wow fadeInUp">
...
if ($cabs_res && $cabs_res->num_rows > 0) {
    ...
    echo "<div class='alert alert-info py-4 text-center'>No cabs available for this route currently.</div>";
}
?>
